...
const createUser = async (name, email, password, biography, photo = "") => {
  let connection;
  ...
  try {
    ...
    const [newUser] = await connection.query(
      `
      INSERT INTO users (name, email, password, biography, photo) VALUES(?, ?, ?, ?, ?)
    `,
      [name, email, passwordHash, biography, photo]
    );
